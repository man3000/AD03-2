...
public class removeProducto extends javax.swing.JDialog {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            VentanaPrincipal.Empresa.Tiendas.get(i).Productos.remove(j);
            JOptionPane.showMessageDialog(this, "Producto eliminado");
            VentanaPrincipal.actualizarJson();
            this.dispose();
        } catch (ArrayIndexOutOfBoundsException e){
            JOptionPane.showMessageDialog(this, "No exixten productos en esta tienda");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(removeProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                removeProducto dialog = new removeProducto(new javax.swing.JFrame(), true);
    ...
    public void fijarModeloProductos(){
        ArrayList<String> cadena = new ArrayList<>();
        int i = this.jComboBox1.getSelectedIndex();
        for (Producto p : VentanaPrincipal.Empresa.Tiendas.get(i).getProductos()){
            cadena.add(p.getId());
        }
        DefaultComboBoxModel model = new DefaultComboBoxModel(cadena.toArray());
