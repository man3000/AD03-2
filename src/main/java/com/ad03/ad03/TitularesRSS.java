/*
 * GUI donde mostraremos los titulares RSS
 */
 ...
 * @author Manuel
 */
public class TitularesRSS extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public TitularesRSS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TitularesRSS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TitularesRSS dialog = new TitularesRSS(new javax.swing.JFrame(), true);
