...
public class mostrarProductosTienda extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBoxTiendas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mostrarProductosTienda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mostrarProductosTienda dialog = new mostrarProductosTienda(new javax.swing.JFrame(), true);
